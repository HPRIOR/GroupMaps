...
//import MockedGoogleMap from './components/GoogleMap';
...
it('Displays input post code - mock fetch', async () => {
    ...
    const postCodeTextContent = container.querySelector('li').textContent;
    expect(postCodeTextContent.includes("N7 9RA")).toBe(true)
});
